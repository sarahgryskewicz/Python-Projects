# All programs included in this folder will analyze satellite and model data. Some valuable resources include: </p>
## Herbie Python Package </p>
Herbie is a fantastic resource for retrieving and analyzing archived NWP model data. More information about the module can be accessed here: https://herbie.readthedocs.io/en/latest/index.html </p>
## GOES-2-go Python Package </p> 
